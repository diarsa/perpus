                                    ...
                                    <span wire:key="paginator-{{ $paginator->getPageName() }}-page{{ $page }}">
                                        @if ($page == $paginator->currentPage())
                                            <span aria-current="page">
                                                <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-black text-white bg-zinc-900 border border-zinc-900 cursor-default leading-5 dark:bg-zinc-200 dark:text-zinc-900 dark:border-zinc-200 z-10">{{ $page }}</span>
                                            </span>
                                        @else
